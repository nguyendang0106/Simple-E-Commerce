...
const VerticalCardProduct = ({category, heading}) => { // category: Danh mục sản phẩm (dùng để fetch dữ liệu sản phẩm theo danh mục). heading: Tiêu đề của danh mục sản phẩm.
    ...
    const loadingList = new Array(13).fill(null) // Mảng có 13 phần tử null để tạo các phần tử skeleton loading.
