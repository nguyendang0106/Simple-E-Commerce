...
const CategoryWiseProductDisplayCart = ({heading}) => {
    ...
    const fetchData = async () => {
        ...
        console.log("cart wise product data",allProduct)
        setData(allProduct);
    };
    ...
    <div className='container mx-auto px-4 my-6 relative'>
           ...
           <div className='grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none transition-all'>
           {
                ...
                loading ? (
                    ...
                    data && getRandomProducts(data, 6).map((product,index)=>{
                        return(
...
export default CategoryWiseProductDisplayCart